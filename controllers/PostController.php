...
use travis83bui\blog\models\Post;
use travis83bui\blog\models\Comment;
use travis83bui\blog\models\Tag;

class PostController extends Controller
{
	public $layout='@app/views/layouts/blog';
	...
	public function actionIndex($tag='')
	{
		...
		echo $this->render('@app/views/modules/blog/views/post/index', array(
				'models' => $models,
